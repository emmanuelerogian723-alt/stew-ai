...
class Chat {
  ...
  /**
   * Stream a chat response using the OpenAI-compatible endpoint.
   * Calls onToken for each token chunk as it arrives.
   ...
   * Accepts standard OpenAI-format messages array.
   */
