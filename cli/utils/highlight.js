/**
 * Minimal syntax highlighter for terminal output — zero dependency.
 * Highlights: keywords, strings, comments, numbers, function names.
 * Supports: js, ts, py, go, rust, java, css, html, json, bash, sh
 */
const C = {
...
function highlightCode(code, lang = 'js') {
  // Don't highlight in raw mode or if no color support
...
/**
 * Detect language from file extension or fence name.
 */
