/**
 * File operations for Stew Code — zero dependency file system utilities.
 * Supports: read, write, list, glob, diff, undo stack, project context.
 */
const fs = require('fs');
